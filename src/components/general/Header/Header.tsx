    ...
    <div className={s.header}>
      ...
      <nav className={s.header__nav}>
        ...
        <ul>
          ...
          <li><Link href="/film">Фильмы</Link></li>
          <li><a>Сериалы</a></li>
      ...
      <div className={s.header__profile}>
        <ul>
          <li><button className={s.profile__btn}>
            <a href={'https://www.ivi.ru/login?action=%2Fuser%2Fsubscription&buy=true&type=subscriptionChange&renew_period=2592000&subscription_id=6&redirect_url=%2F&from=top_menu'}>
               Оплатить подписку
            </a>
          </button></li>
